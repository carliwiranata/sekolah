    ...
    <div class="row">
        <div class="col-lg-7 col-md-6 col-lg-6 mx-auto">
            <div class="card">
                ...
                <form action="<?= base_url('admin/tambahekskul') ?>" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="form-group">
                            <label>Nama Ekskul <span class="text-danger">*</span></label>
                            <input type="text" name="nama_ekskul" value="<?= set_value('nama_ekskul') ?>" class="form-control">
