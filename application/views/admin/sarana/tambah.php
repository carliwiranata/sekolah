    ...
    <div class="row">
        <div class="col-lg-7 col-md-6 col-lg-6 mx-auto">
            <div class="card">
                ...
                <form action="<?= base_url('admin/tambahsarana') ?>" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="summernote" name="keterangan"><?= set_value('keterangan') ?></textarea>
